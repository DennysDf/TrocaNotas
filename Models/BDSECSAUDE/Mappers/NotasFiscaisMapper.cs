...
{
    public class NotasFiscaisMapper : IEntityTypeConfiguration<NotasFiscais>
    {
        public void Configure(EntityTypeBuilder<NotasFiscais> builder)
        {
